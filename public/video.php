<?php
// Get a video from the private directory, checking user access and video status
...
$web = StaysailIO::getInt('w'); // If this is set, the web-sized video will be delivered

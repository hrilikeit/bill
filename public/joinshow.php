...
$MemberId = $Member->id;
$meetingId = $_POST['meeting_id']; // StaysailIO::post('meeting_id');
...
$filters = array(new Filter(Filter::Match, array('Entertainer_id' => $EntertainerId, 'id' => $meetingId)));
$metId = $framework->getSubset('WebShowDyte', $filters);


foreach ($metId as $metIds)
{
    $idMt = $metIds->meeting_id;
}

//$link = "/liveStream.php?authToken=$token&Entertainer_id=$EntertainerId&Member_id=$MemberId&typeOfShow=$typeShow";
$link = "/liveStream.php?authToken=$token&Entertainer_id=$EntertainerId&meeting_id=$idMt&typeOfShow=$typeShow";

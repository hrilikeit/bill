...
<!--    <link rel="apple-touch-icon" sizes="180x180" href="https://stage.yourfanslive.com/site_img/logo-new.png">-->
<!--    <link rel="icon" type="image/png" sizes="32x32" href="https://stage.yourfanslive.com/site_img/logo.png">-->
<!--    <link rel="icon" type="image/png" sizes="192x192" href="https://stage.yourfanslive.com/site_img/logo-new.png">-->
<!--    <link rel="icon" type="image/png" sizes="16x16" href="https://stage.yourfanslive.com/site_img/logo.png">-->
<!--    <link rel="manifest" href="https://stage.yourfanslive.com/site_img/logo-new.png">-->
<!--    <link rel="mask-icon" href="https://stage.yourfanslive.com/site_img/logo-new.png">-->
<!--    <link rel="shortcut icon" href="https://stage.yourfanslive.com/site_img/logo-new.ico">-->
<!--    <link rel="manifest" href="https://stage.yourfanslive.com/manifest.json">-->
    ...
    <div class="container-fluid">
        <div class="row pt-3 pb-4">
            <div class="col-12 col-lg-7">
                <div class="models">
                    <!--<div class="">-->
                    <!--    <img src="site_img/logo.png" alt="Your Fans Live Logo" class="img-fluid">-->
                    <!--</div>-->
                    <div class="pb-4">

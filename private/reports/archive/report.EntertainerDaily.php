...
class EntertainerDaily extends StaysailReport
{
	...
	public function __construct()
	{
		...
		if (isset($_GET["mode"]) && isset($_GET["id"]) && htmlspecialchars($_GET["mode"]) == 'Administrator' && htmlspecialchars($_GET["id"]) == 'EntertainerDaily')
		{
			$this->sql = <<<__END__

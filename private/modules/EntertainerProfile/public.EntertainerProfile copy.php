...
//            }
        ...
        if ($is_deletion_request) {
            $deleteButtton = '<div style="font-size: 11px; display: block; margin-left: 235px;" >Your request to delete account is processing</div>';
        } else {
            $deleteButtton = "<a href='?mode=EntertainerProfile&job=delete_acc' class='delete_acc'>delete account</a>";
        }
        ...
        $writer->addHTML(
            "<div class='modal' id='myModal_delete'>
                <div style='margin: 250px auto;' class='modal-content'>
                    ...
                    <div class='modal-body'>
                            <p style='font-size:20px'>Are you sure you want to permanently delete your account from YourFansLive?</p>
                    </div>
                    <div style='margin: 15px'>" . $deleteButtton . "<button style='width: 100px;margin-left: 5px;' type='button' class='close_delete'>close</button>
                    </div>
                </div>
            </div>");
